...
namespace YChan {
    public class Imageboard {
        ...
        protected bool Archived = false;                 // Flag for archived
        protected bool FirstQuery = false;               // Flag for first Query
        protected string ThreadName = "";                // Found ThreadName
        ...
        public string itsThreadName() {
            return this.ThreadName;
        }

        public bool FirstQueryDone() {
