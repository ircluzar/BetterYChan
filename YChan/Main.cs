    ...
    public partial class frmMain : Form {
        ...
        private void frmMain_Load(object sender, EventArgs e) {
            ...
            if(General.saveOnClose) {                                               // if enabled load URLs from file 
                ...
                DialogResult dr = MessageBox.Show("Load threads from last session?", "confirm that", MessageBoxButtons.YesNo);
                    ...
                    if(threads != "") {
                        ...
                        for(int i = 0; i < URLs.Length - 1; i++) {
                            ...
                            if(newImageboard == null) {
                                ...
                                lbThreads.Items.Add(new IBDownloadItem(URLs[i]));
        ...
        private void openInBrowserToolStripMenuItem_Click(object sender, EventArgs e) {
            if(tPos != -1) {
                string spath = ((IBDownloadItem)lbThreads.Items[tPos]).URL;
                Process.Start(spath);
            }
        }
        ...
        private void frmMain_FormClosing(object sender, FormClosingEventArgs e) {
            ...
            if(General.warnOnClose && clThreads.Count > 0) {
                ...
                */
                ...
                DialogResult rslt = MessageBox.Show("You sure you wanna close Better YChan?", "u srs bro?", MessageBoxButtons.YesNo);
