        ...
        override public void download() {
            ...
            if(General.loadHTML) {
                try {
                    ...
                    XmlNodeList xmlSub     = doc.DocumentElement.SelectNodes("/root/posts/item/sub");

                    try { 
                    this.ThreadName = System.Web.HttpUtility.HtmlDecode(xmlSub[0].InnerText);
                    }catch { }
